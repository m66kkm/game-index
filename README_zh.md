...
# Game Index (游戏仓鼠的炫耀空间)

<p align="center">
  <img src="assets/app_logo.jpg" width="200" alt="App Logo" />
</p>

**Game Index** 不仅仅是一个本地游戏管理工具，它更是**“仓鼠型玩家”**（热衷于疯狂下载和囤积数字游戏、光盘镜像、免安装版的数字资产收藏家）专属的终极兵器与炫耀展厅！

还在看着硬盘里杂乱无章的 "fitgirl-repack", "XYZ破解版", "某某游戏免安装中文版" 文件夹发愁吗？Game Index 能以毫秒级速度扫描你的整个硬盘，自动清洗这些杂乱的命名，智能匹配 Steam 官方接口，并为你自动挂载正版中文译名、发售时间、玩家好评率，甚至在本地离线缓存高清海报。

打造一个极具赛博感、让你忍不住向朋友炫耀的私人数字游戏展厅，就是这么简单！
